  ...
  return (
    <div className="text-white pb-10 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="relative h-[110px] md:h-[130px] rounded-2xl p-4 md:p-6 flex flex-col justify-center overflow-hidden shadow-lg bg-gradient-to-br from-emerald-600 to-emerald-700">
        ...
        <div className="relative h-[110px] md:h-[130px] rounded-2xl p-4 md:p-6 flex flex-col justify-center overflow-hidden shadow-lg bg-gradient-to-br from-blue-600 to-blue-700">
          <div className="relative z-[2] flex justify-between items-start mb-2">
        ...
        <div className="relative h-[110px] md:h-[130px] rounded-2xl p-4 md:p-6 flex flex-col justify-center overflow-hidden shadow-lg bg-gradient-to-br from-red-600 to-red-700">
          <div className="relative z-[2] flex justify-between items-start mb-2">
            ...
            {wishlists.length === 0 ? (
              ...
              >
                {wishlists.slice(0, 5).map(item => {
                  ...
                  return (
                    <div key={item.id} className="bg-gray-800 rounded-xl p-5 text-white shrink-0 shadow-lg border border-white/5">
