...
export default function Login() {
  ...
  function handleGoogleLogin() {
    toast.error('Login dengan Google belum tersedia saat ini 🚧')
  }
    ...
    <div className="min-h-screen flex items-center justify-center relative bg-[#101010] overflow-hidden font-['Inter',_sans-serif]">
      ...
      <div className="relative z-10 w-full max-w-[90%] min-[577px]:max-w-[420px] bg-[#525050]/60 rounded-2xl py-10 px-[30px] min-[577px]:px-10 shadow-[0_10px_40px_rgba(0,0,0,0.5)] backdrop-blur-[10px] border border-white/10 animate-scale-in">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col">
          ...
          {/* reCAPTCHA */}
          <div 
            className="mt-10 bg-[#f9f9f9] border border-[#d3d3d3] rounded-[3px] p-3 w-full flex justify-between items-center cursor-pointer select-none transition-colors hover:bg-[#f1f1f1]"
            onClick={() => setCaptchaChecked(!captchaChecked)}
          >
            <div className="flex items-center gap-3 text-[#333] text-[13px] font-['Inter',_sans-serif]">
              <div className="flex items-center justify-center w-7 h-7 border-2 border-[#c1c1c1] rounded-sm bg-white overflow-hidden transition-all duration-200">
                {captchaChecked && (
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#009E55" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" className="animate-[scaleIn_0.2s_ease-out]">
            ...
            <img src="https://www.gstatic.com/recaptcha/api2/logo_48.png" alt="reCAPTCHA" className="h-8 ml-auto" />
          </div>
        ...
        <button 
          type="button" 
          className="mt-5 w-full bg-[#e0e0e0] text-[#333] border-none p-3 text-[16px] font-medium rounded cursor-pointer flex items-center justify-center gap-2.5 transition-colors duration-200 hover:bg-[#d0d0d0] font-['Inter',_sans-serif]" 
